using AutoMapper;
using DAL;
using EfficientFood.UI.Helpers;
using EfficientFood.UI.ViewModels;
...
namespace EfficientFood.UI.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        public async Task<string> Email()
        {
            ...
            (bool success, string errorMsg) = await _emailSender.SendEmailAsync(recepientName, recepientEmail, "Test Email from EfficientFood.UI", message);
